...
public class DownloadManager {
    ...
    private String FILE_PATH_DOWNLOAD = Environment.getExternalStorageDirectory() +
    ...
    public DownloadManager add(String url, String filePath, String fileName, long contentLength, long blockLength, DownloadListener listener) {
        ...
        DownloadTask task = new DownloadTask(context,url, filePath, fileName, contentLength, blockLength, listener);
