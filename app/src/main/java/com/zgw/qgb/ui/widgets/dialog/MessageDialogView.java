...
import com.zgw.qgb.base.BaseBottomSheetDialog;
...
public class MessageDialogView extends BaseBottomSheetDialog {
    ...
    @NonNull
    public static MessageDialogView newInstance(@NonNull String bundleTitle, @NonNull String bundleMsg, boolean isMarkDown) {
    ...
    @NonNull
    public static MessageDialogView newInstance(@NonNull String bundleTitle, @NonNull String bundleMsg, @Nullable Bundle bundle) {
