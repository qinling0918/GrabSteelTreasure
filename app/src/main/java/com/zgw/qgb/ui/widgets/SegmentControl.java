 ...
 * Name:SegmentControl
 * Comment://todo
 * Created by Tsinling on 2017/5/20 16:40.
 */
...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        mHorizonGap = mHorizonGap == 0?gap:mHorizonGap;
        mVerticalGap = mVerticalGap == 0?gap:mVerticalGap;
    ...
    public int getSelectedIndex() {
        Log.d("getSelectedIndex",""+mCurrentIndex);
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        //把当前的位置保存进SavedState
        ss.mCurrentIndex = mCurrentIndex;
        return ss;
    }
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        setSelectedIndex(ss.mCurrentIndex);
    }
    ...
    static class SavedState extends BaseSavedState {
        ...
        private SavedState(Parcel in) {
            super(in);
            mCurrentIndex = (int)in.readValue(null);
        }

        @Override
        public void writeToParcel(Parcel out, int flags) {
            super.writeToParcel(out, flags);
            out.writeValue(mCurrentIndex);
        }
